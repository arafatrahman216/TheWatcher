...
def register(router):
    ...
    async def get_recent_activity_endpoint(monitor: str ,db: Session = Depends(get_db)):
        return await get_uptime_stats(monitor)
    ...
    try:
        ...
        try:
            ...
            if monitor_data and "monitors" in monitor_data and monitor_data["monitors"]:
                ...
                return _build_stats_from_uptimerobot(monitor, website)
            else:
