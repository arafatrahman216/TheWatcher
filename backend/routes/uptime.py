...
async def send_discord_report(db: Session = Depends(get_db)):
    ...
    try:
        ...
        # SSL report using get_ssl_certificate_info
        ssl_status = "Unknown"
        ssl_expiry = "Unknown"
        ...
        if ssl_info:
            ...
            if days_left is not None:
                ...
                ssl_days_remaining = "N/A"
            # If cert_exp is present and False, mark as expired
            if ssl_info.get('cert_exp') is True:
                ssl_status = "Expired"

        # Format report message as an official code block
        ...
        # Use Asia/Dhaka timezone (GMT+6) for report time
        ...
        # Convert last_check to Asia/Dhaka timezone if possible
